...
const captions = {
    ...
    if (this.isHTML5 && this.isVideo) {
      tracks
        ...
        .forEach(track => {
          ...
          on.call(this, track, events.CUE_CHANGE, () => captions.updateCues.call(this));
        });
    }
  ...
  set(index, passive = true) {
    ...
    if (this.captions.currentTrack !== index) {
      ...
      // Show the select track and hide the others
      tracks.forEach(t => {
        t.mode = 'hidden';
      });
      track.mode = 'showing';
      ...
      // Trigger event
      triggerEvent.call(this, this.media, events.LANGUAGE_CHANGE);
    }
  ...
  updateCues(input) {
    ...
    if (changed) {
      ...
      // Trigger event
      triggerEvent.call(this, this.media, events.CUE_CHANGE);
    }
  },
};
