// Type definitions for uiza v5
// Project: https://uiza.io
// TypeScript Version: 3.0

export = Uiza;
export as namespace Uiza;

declare class Uiza {
  /**
   * Setup a new instance
   */
  static setup(targets: NodeList | HTMLElement | HTMLElement[] | string, options?: Uiza.Options): Uiza[];
   ...
   */
  static supported(mediaType?: Uiza.MediaType, provider?: Uiza.Provider, playsInline?: boolean): Uiza.Support;

  constructor(targets: NodeList | HTMLElement | HTMLElement[] | string, options?: Uiza.Options);
  ...
  readonly fullscreen: Uiza.FullscreenControl;
   ...
   */
  on(
    event: Uiza.StandardEvent | Uiza.Html5Event | Uiza.YoutubeEvent,
    callback: (this: this, event: Uiza.UizaEvent) => void,
  ): void;
...
declare namespace Uiza {
  type MediaType = 'audio' | 'video';
  type Provider = 'html5' | 'hlsjs';
  type StandardEvent =
    | 'progress'
    | 'playing'
    | 'play'
  ...
  interface Options {
    /**
     * Completely disable Uiza. This would allow you to do a User Agent check or similar to programmatically enable or disable Uiza for a certain UA. Example below.
     */
    enabled?: boolean;
    ...
    /**
     * Specify the id prefix for the icons used in the default controls (e.g. Uiza-play would be Uiza).
     ...
     */
    listeners?: { [key: string]: (error: UizaEvent) => void };
  ...
  interface SourceInfo {
     ...
     * it will render as <track kind="captions" label="English" srclang="en" src="https://cdn.selz.com/Uiza/1.0/example_captions_en.vtt" default> and similar for the French version.
  ...
  interface UizaEvent extends CustomEvent {
    readonly detail: { readonly Uiza: Uiza };
  }
